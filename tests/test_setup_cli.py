...
def test_setup_prepares_runtime_and_prints_next_steps(
    monkeypatch: pytest.MonkeyPatch, capsys: pytest.CaptureFixture[str], tmp_path: Path
) -> None:
    setup_module = importlib.import_module("holo_desktop.cli.setup")
...
def test_setup_can_run_login_and_host_install(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    setup_module = importlib.import_module("holo_desktop.cli.setup")
    ...
    setup_module.setup(yes=True, login=True, install_hosts=True)
